...
def SVM(train_data,
    ...
    # YOUR CODE GOES HERE
    SVM = svm.SVC(kernel=kernel, C=100, gamma=0.1)
    ...
    """
    train_accuracy = calculate_accuracy(SVM.predict(train_data), train_labels)
    ...
    accuracy = calculate_accuracy(SVM.predict(test_data), test_labels)
...
if __name__ == '__main__':
    ...
    # YOUR CODE GOES HERE
    accumulated_metrics = np.asarray(accumulated_metrics)
    mean = accumulated_metrics.mean(axis=0)
